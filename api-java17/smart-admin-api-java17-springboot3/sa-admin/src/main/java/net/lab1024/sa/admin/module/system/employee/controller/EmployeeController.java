...
public class EmployeeController {
    ...
    @TablePermission(module = "employee", operation = TableOperationEnum.VIEW)
    ...
    @TablePermission(module = "employee", operation = TableOperationEnum.EDIT)
    ...
    @TablePermission(module = "employee", operation = TableOperationEnum.DELETE)
